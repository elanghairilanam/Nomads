                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-details card-right">
                            ...
                            <img src="{{ url('frontend\images\Gopay_logo.svg-removebg-preview.png') }}" class="w-50">
                        </div>
                        <div class="join-container">
                            <a href="{{ route('checkout-success', $item->id) }}" class="btn btn-block btn-pay-now mt-3 py-2">
                                Process Payment
                            </a>
                        </div>
...
<script>
        $(document).ready(function() {
            ...
            $('.datepicker').datepicker({
                ...
                icons: {
                    rightIcon: '<img src="' + window.location.origin + '/frontend/images/ic_doe.png"/>'
                }
            })
        })
    </script>
